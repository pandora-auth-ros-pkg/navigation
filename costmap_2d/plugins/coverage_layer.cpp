...
CoverageLayer::CoverageLayer() : dsrv_(NULL) {}
...
void CoverageLayer::onInitialize()
{
  ...
  map_sub_ = g_nh.subscribe(map_topic, 1, &CoverageLayer::incomingMap, this);
  map_received_ = false;
  ...
  if(subscribe_to_updates_)
  {
    ...
    map_update_sub_ = g_nh.subscribe(map_topic + "_updates", 10, &CoverageLayer::incomingUpdate, this);
  }
...
unsigned char CoverageLayer::interpretValue(unsigned char value)
{
...
void CoverageLayer::incomingMap(const nav_msgs::OccupancyGridConstPtr& new_map)
{
...
void CoverageLayer::incomingUpdate(const map_msgs::OccupancyGridUpdateConstPtr& update)
{
    unsigned int di = 0;
