...
#include <costmap_2d/RangeSensorLayerConfig.h>
...
private:
  void reconfigureCB(costmap_2d::RangeSensorLayerConfig &config, uint32_t level);
  ...
  dynamic_reconfigure::Server<costmap_2d::RangeSensorLayerConfig> *dsrv_;
};
}
#endif